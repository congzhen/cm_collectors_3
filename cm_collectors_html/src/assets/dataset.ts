export default {
  ...
  resourcesShowMode: ['coverPoster', 'coverPosterBox', 'coverPosterBoxWideSeparate', 'coverPosterSimple', 'coverPosterSimpleExpand', 'coverPosterWaterfall', 'shortVideo', 'shortVideoTopBottom', 'table'],
