...
const emptyStatus = (): I_performerAvatarLibraryStatus => ({
  ready: false, updating: false, fileSize: 0, updatedAt: '', dataTimestamp: '', totalNum: '', totalSize: '', activeBaseUrl: '',
  setting: { customBaseUrl: '', defaultStrategy: 'recommended' },
});
const status = reactive<I_performerAvatarLibraryStatus>(emptyStatus());
const setting = reactive<I_performerAvatarLibrarySetting>({ customBaseUrl: '', defaultStrategy: 'recommended' });
