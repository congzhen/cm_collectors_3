...
- **Windows 版**: [cm_collectors_3_windows.zip](https://github.com/congzhen/cm_collectors_3/releases/latest/download/cm_collectors_3_windows.zip)
- **Linux 版**: [cm_collectors_3_linux.zip](https://github.com/congzhen/cm_collectors_3/releases/latest/download/cm_collectors_3_linux.zip)
